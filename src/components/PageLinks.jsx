...
function PageLink({ page }) {
  return (
    <article key={page.href}>
      ...
      >
        <h3 className="mt-6 text-base font-semibold text-[#e14242]">
          {page.title}
        </h3>
        <time
          dateTime={page.date}
        ...
        <Link
          href={page.href}
          className="mt-6 flex gap-x-3 text-base font-semibold text-[#e14242] transition hover:text-neutral-700"
